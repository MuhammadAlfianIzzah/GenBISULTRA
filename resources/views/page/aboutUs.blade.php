                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            <strong>Website</strong> ini dibuat pada tahun 2021 tepatnya pada masa jabatan ketua umum
                            <strong>Febriansyah</strong> dan wakilnya <strong> Muhammad Akbar Milu</strong>
                            <h5 class="mt-2 blockquote">Cerita Singkat</h5> Website ini di usulkan oleh ketua GenBI UHO
                            2021 yaitu <strong class="text-primary">Yessi Yuniarti</strong> pada masa tengah
                            jabatannya, dan dibuat 100% oleh anggota GenBI Departement <strong>KOMINFO</strong>, Bisa
                            dikatakan tidak langsung ini juga merupakan program kerja <strong>KOMINFO</strong>
                            <br>
                        </div>
                    </div>
