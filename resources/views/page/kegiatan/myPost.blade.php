<x-dash-layout>
    <div class="col-8">
        <a href="{{ route('create-kegiatan') }}" class="btn btn-primary"> <i class="fas fa-pen"></i> Create Posts</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route("izin-kegiatan",[$post->slug,"accept"]) }}" class="btn btn-success {{$post->is_active == true ? "disabled":""}}"><i class="far fa-check-circle"></i></a>

                                <a href="{{ route("izin-kegiatan",[$post->slug,"null"]) }}" class="btn btn-danger {{$post->is_active == true? "":"disabled"}}"><i class="fa fa-times"></i></a>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('edit-kegiatan',"$post->slug") }}" class="btn btn-primary">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('delete-kegiatan',"$post->slug") }}" style="display: inline;" method="POST">
