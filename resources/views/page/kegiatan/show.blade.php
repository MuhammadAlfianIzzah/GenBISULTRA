        ...
        <div class="mt-r img-size-responsif">
            ...
            <div class="p-5 px-0 mb-4 rounded-3 z-99 text-white" style="z-index: 88;position: relative;">
                <div class="container py-5 d-flex flex-column align-items-center bg-lapis">
                    ...
                    <p class="col-md-8 text-center">Yuk lihat lihat apa apa saja kegiatan GenBI yang telah dilakukan,
        ...
        <div class="album pb-4 bg-light">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 mt-2">
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                <div class="hightlight d-flex align-items-center">
                                    ...
                                    <img width="40px" class="me-2" src="{{ asset("storage/$logo") }}"
                    ...
                    @empty
                        <div class="alert alert-warning w-100 d-flex align-items-center justify-content-center shadown mt-4"
                            role="alert">
