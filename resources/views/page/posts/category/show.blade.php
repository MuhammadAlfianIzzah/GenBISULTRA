<x-dash-layout>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                ...
                                <form action="{{ route('delete-category-posts',"$ct->id") }}" style="display: inline;" method="POST">

                                    @method("delete")
                                    @csrf
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{$ct->id}}">

                                        Delete
                                    </button>
                                    <!-- Modal -->
                                    <div class="modal fade" id="delete{{$ct->id}}" tabindex="-1" aria-labelledby="delete{{$ct->id}}Label" aria-hidden="true">
    ...
    <!-- Modal -->
    <div class="modal fade {{$errors->all()?"show":""}}" id="create_category" tabindex="-1" aria-labelledby="create_categoryLabel" aria-hidden="true" role="dialog">
            ...
            <div class="modal-content">
                <form action="" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="create_categoryLabel"> <i class="fas fa-pen"></i> Create Category Posts</h5>
