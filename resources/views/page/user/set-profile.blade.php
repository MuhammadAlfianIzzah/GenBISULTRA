                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <img style="max-height: 200px;object-fit: contain"
                            class="w-100 d-none img-fluid img-thumbnail foto-profile">
                    ...
                    <div class="mb-3">
                        ...
                        <img style="max-height: 200px;object-fit: contain"
                            class="w-100 d-none img-fluid img-thumbnail hero">
                        <input name="hero" class="form-control input-show upload-img" type="file" id="hero" required
                            data-target="hero">
                        <span class="text-scaledown">(Gunakan gambar yang persegi panjang)</span>
                        @error('hero')
                            <div class="text-danger text-small">{{ $message }}</div>
