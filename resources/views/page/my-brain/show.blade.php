<x-m-layout-v2>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative card-brain">
                    <div class="col p-4 d-flex flex-column position-static align-content-center justify-content-center gap-1">
                        <strong class="d-inline-block mb-2 text-primary">🌶️{{$post->category}}</strong>
                        <h3 class="mb-0">{{$post->title}}</h3>
                        <div class="mb-1 text-muted">{{ \Carbon\Carbon::parse($post->created_at)->diffForHumans() }}</div>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img class="bd-placeholder-img" style="height: 250px;object-fit: contain;width: 200px" src="{{ asset("storage/$post->thumbnail") }}" alt="{{$post->title}}">
                    </div>
                </div>
            </div>
