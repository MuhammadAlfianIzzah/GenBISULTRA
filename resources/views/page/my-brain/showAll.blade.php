                            ...
                            <tr>
                                ...
                                @role(['admin', 'super'])
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('approvalPost', [$post->slug, 'accept']) }}"
                                                class="btn btn-success {{ $post->approval == 'accept' ? 'disabled' : '' }}"><i
                                                    class="far fa-check-circle"></i></a>
                                            <a href="{{ route('approvalPost', [$post->slug, 'null']) }}"
                                                class="btn btn-danger {{ $post->approval == 'accept' ? '' : 'disabled' }}"><i
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <form action="{{ route('delete-brain', "$post->slug") }}"
